...
#include <stdint.h>                       // C99-standard exact-width integers
                   ...
                   // (currently Preemptive kernel is not supported in MAPLE)
...
#define __NVIC_PRIO_BITS 4  // For Cortex-M3
    /* QF-aware ISR priority for CMSIS function NVIC_SetPriority()          */
...
/* QK_PREEMPTIVE IT IS STILL NOT SUPPORTED ON MAPLE !!!  */
#ifdef QK_PREEMPTIVE
    ...
    #define QK_ISR_ENTRY()    do { \
     ...
     //*Q_UINT2PTR_CAST(uint32_t, 0xE000ED04U) = (uint32_t)0x10000000U;
           //*((uint32_t *)(0xE000ED04U)) = (uint32_t)0x10000000U;  
...
///
#define Q_UINT2PTR_CAST(type_, uint_)  (reinterpret_cast<type_ *>(uint_))  //by JK
